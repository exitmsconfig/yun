...
# Date:		2013-10-09
# Corp.:	Chenlei
# Author:	exitmsconfig@gmail.com, exitmsconfig@gmail.com (U can msn me with this), QQ exitmsconfig@gmail.com
...
# or email to me directly: exitmsconfig@gmail.com or exitmsconfig@gmail.com
#########################################################################
# Todo:
...
print_help_msg(){
	...
	$Echo 
        $Echo 'Report bugs to: exitmsconfig@gmail.com'
        $Echo 'Home page: <http://bbs.itnms.info/forum.php?mod=viewthread&tid=767&extra=page%3D1>'
        $Echo 'Geting help: <http://bbs.itnms.info/forum.php?mod=forumdisplay&fid=10&page=1> or Email to: exitmsconfig@gmail.com'
